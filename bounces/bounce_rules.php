...
require_once(dirname(__FILE__).'/bounce_body_rules.php');
require_once(dirname(__FILE__).'/bounce_dsn_rules.php');
require_once(dirname(__FILE__).'/bounce_other_rules.php');
